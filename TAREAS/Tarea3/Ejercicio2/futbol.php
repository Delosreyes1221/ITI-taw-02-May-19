...
<body style="background:url('futbol.jpg'); opacity:0.95;">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="createFutbolista.php" class="btn btn-info add-new"><i class="fa fa-plus"></i> Agregar Futbolista</a>
                    </div>
                </div>
            </div>
    ...
    //                //while ($row=mysqli_fetch_object($listado)){
                    ...
                    $email=$lista->email;
                ?>
                <!-- Se impirmen las variables dentro de una tabla que muestran la informacion de las filas -->
                    <tr>
                    ...
                    <a href="updateFutbolista.php?id=<?php echo $id;?>" class="edit" title="Editar" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                    <a href="deleteFutbolista.php?id=<?php echo $id;?>" class="delete" title="Eliminar" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                    </td>
                    </tr>	
                    <?php
                    }
