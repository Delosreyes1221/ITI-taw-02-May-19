...
class MvcController{
	...
	public function vistaClientesController(){
		...
		echo'<tr>
				...
				<td><a href="index.php?action=editar&id='.$item["id_cliente"].'"><button type="button" class="btn btn-info">Editar</button></a></td>
				<td><a href="index.php?action=usuarios&idBorrar='.$item["id_cliente"].'"><button type="button" class="btn btn-danger">Borrar</button></a></td>
			</tr>';
	...
	public function vistaReservacionController(){
		...
		echo'<tr>
				...
				<td><a href="index.php?action=editar&id='.$item["id_reservacion"].'"><button type="button" class="btn btn-info">Editar</button></a></td>
				<td><a href="index.php?action=usuarios&idBorrar='.$item["id_reservacion"].'"><button type="button" class="btn btn-danger">Borrar</button></a></td>
			</tr>';
	...
	public function actualizarUsuarioController(){
		...
		if(isset($_POST["nombreEditar"])){
			...
			$respuesta = Datos::actualizarUsuarioModel($datosController, "clientes");
	...
	public function vistaHabitacionesController(){
		...
		echo'<tr>
				...
				<td>'.$item["tipo"].'</td>
				<td>'.$item["precio"].'</td>
				<td><a href="index.php?action=editarPro&id='.$item["id_habitacion"].'"><button type="button" class="btn btn-info">Editar</button></a></td>
				<td><a href="index.php?action=productos&idBorrar='.$item["id_habitacion"].'"><button type="button" class="btn btn-danger">Borrar</button></a></td>
			</tr>';
	...
	public function registroReservacionController(){
		...
		if(isset($_POST["tipoReservacion"])){
			...
			//SI ES CORRECTO LLAMA LA ACTION OKVEN DE ENLACES
			if($respuesta == "success"){	
				header("location:index.php?action=okRes");
			}
			else{
				header("location:index.php");
			}
