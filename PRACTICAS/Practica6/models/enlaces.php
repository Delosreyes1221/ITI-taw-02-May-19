...
class Paginas{
	...
	public static function enlacesPaginasModel($enlaces){
		...
		if($enlaces == "ingresar" || $enlaces == "usuarios" || $enlaces == "editar" || $enlaces == "salir" || $enlaces == "productos" || $enlaces == "registroPro" || $enlaces == "editarPro" || $enlaces == "ventas" || $enlaces == "registroVen"
		 || $enlaces == "editarVen" || $enlaces == "reservacion" || $enlaces == "registroRes" || $enlaces == "reservacionHabitacion" || $enlaces == "reservacionesHabitaciones" || $enlaces == "editarReservacion"){
			//ASIGNA EL VALOR DE LA VISTA A LA QUE TIENE VALOR
			$module =  "views/modules/".$enlaces.".php";

		}
		//MANDA AL INDEX DE REGISTRO
		else if($enlaces == "index22"){
		...
		//CORRECTO REGISTRO DE PRODUCTO
		else if($enlaces == "okRes"){

			$module =  "views/modules/registroRes.php";

		}

		else if($enlaces == "okReservacionHabitacion"){

			$module =  "views/modules/reservacionesHabitaciones.php";
		...
		else if($enlaces == "cambioReservacion"){

			$module =  "views/modules/reservacion.php";
