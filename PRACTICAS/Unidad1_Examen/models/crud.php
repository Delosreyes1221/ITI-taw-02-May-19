...
class Datos extends Conexion{
	...
	public static function registroAlumnoModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (clave, nombre, rfc, direccion, email) VALUES (:clave,:nombre,:rfc,:direccion, :email)");

		#bindParam() Vincula una variable de PHP a un parámetro de sustitución con clave o de signo de interrogación correspondiente de la sentencia SQL que fue usada para preparar la sentencia.
...
#OBTENER ALUMNOS
	...
	public static function registroMaestroModel($datosModel, $tabla){
		...
		//preparamos la conexion para ejecutar la sentencia sql
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre, apellidos, email, telefono, clave) VALUES (:nombre,:apellidos,:email,:telefono, :clave)");
...
//PREPARA PARA OBTENER TODOS LOS DATOS DE LA TABLA DE USUARIOS PARA EDITAR UN REGISTRO
		$stmt = Conexion::conectar()->prepare("SELECT clave, nombre, rfc, direccion, email FROM $tabla WHERE clave = :id");
		$stmt->bindParam(":id", $datosModel, PDO::PARAM_INT);
		$stmt->execute();
...
//PREPARA PARA OBTENER TODOS LOS DATOS DE LA TABLA DE USUARIOS PARA EDITAR UN REGISTRO
		$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE nombre = :id");
		$stmt->bindParam(":id", $datosModel, PDO::PARAM_INT);
		$stmt->execute();
...
//PREPARA PARA OBTENER TODOS LOS DATOS DE LA TABLA DE USUARIOS PARA EDITAR UN REGISTRO
	...
	public static function actualizarAlumnoModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, rfc = :rfc, direccion = :direccion, email = :email WHERE clave = :clave");
	...
	public static function actualizarMaestroModel($datosModel, $tabla){
		//PREPARA PARA ACTUALIZAR LOS DATOS DE UN REGISTRO DE LA TABLA USUARIOS
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET apellidos = :apellidos, email = :email, telefono = :telefono,
...
//PREPARA PARA OBTENER TODOS LOS DATOS DE LA TABLA DE USUARIOS PARA EDITAR UN REGISTRO
	...
	public static function borrarAlumnoModel($datosModel, $tabla){
		...
		$stmt->bindParam(":clave", $datosModel, PDO::PARAM_INT);
	...
	public static function borrarMaestroModel($datosModel, $tabla){
		...
		$stmt->bindParam(":nombre", $datosModel, PDO::PARAM_INT);
