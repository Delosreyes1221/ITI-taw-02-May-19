        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <a href="index.php?action=usuarios"><i class="fas fa-user-friends "></i>PROVEEDORES  <span class="badge"></span></a>
                    </li>
                    <li>
                        <a href="index.php?action=maestro"><i class="fas fa-user-friends "></i>CONTACTOS  <span class="badge"></span></a>
                    </li>
